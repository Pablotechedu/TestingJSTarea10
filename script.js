...
const sillySentence = (adjetive, verb, noun) => {
  return `I am so ${adjetive} because I ${verb} coding! Time to write some more awesome ${noun}!`;
};
console.log(sillySentence("excited", "love", "functions"));
...
const howOld = (age, year) => {
  ...
  if (year > thisYear) {
    return `Tu tendrás ${newAge} en el año ${year}.`;
  } else if (year < thisYear - age) {
    return `El año ${year} fue ${thisYear - year - age} años antes de nacer.`;
  } else {
    return `Tu tenías ${newAge} en el año ${year}.`;
  }
};

console.log(howOld(25, 2050)); // Tu tendrás 50 en el año 2050.
console.log(howOld(25, 1990)); // El año 1990 fue 10 años antes de nacer.
console.log(howOld(25, 2000)); // Tu tenías 0 en el año 2000.
...
console.log(toEmoticon("other")); // Should print '|_(* ~ *)_|'
